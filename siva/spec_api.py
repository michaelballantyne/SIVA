...
def calculator(input: NodeRef | None = None, **props) -> NodeRef:
...
def cell_to_point(input: NodeRef | None = None, **props) -> NodeRef:
...
def clip(input: NodeRef | None = None, origin=None, normal=None, inside_out=False, **props) -> NodeRef:
...
def clip_box(input: NodeRef | None = None, bounds=None, inside_out=True, **props) -> NodeRef:
...
def clip_sphere(input: NodeRef | None = None, center=None, radius=100, inside_out=True, **props) -> NodeRef:
...
def contour(input: NodeRef | None = None, **props) -> NodeRef:
...
def elevation(input: NodeRef | None = None, low_point=None, high_point=None, **props) -> NodeRef:
...
def extract_grid(input: NodeRef | None = None, **props) -> NodeRef:
...
def filter(vtk_class, input: NodeRef | None = None, **props) -> NodeRef:
...
def glyph(input: NodeRef | None = None, **props) -> NodeRef:
...
def gradient(input: NodeRef | None = None, **props) -> NodeRef:
...
def mask_points(input: NodeRef | None = None, **props) -> NodeRef:
...
def outline(input: NodeRef | None = None, **props) -> NodeRef:
...
def point_to_cell(input: NodeRef | None = None, **props) -> NodeRef:
...
def probe(input: NodeRef | None = None, source: NodeRef | None = None, **props) -> NodeRef:
...
def resample_to_image(input: NodeRef | None = None, dimensions=None, **props) -> NodeRef:
...
def slice(input: NodeRef | None = None, origin=None, normal=None, **props) -> NodeRef:
...
def smooth(input: NodeRef | None = None, iterations=20, **props) -> NodeRef:
...
def source(vtk_class, **props) -> NodeRef:
...
def stream_tracer(input: NodeRef | None = None, **props) -> NodeRef:
...
def surface(input: NodeRef | None = None, **props) -> NodeRef:
...
def threshold(input: NodeRef | None = None, **props) -> NodeRef:
...
def tube(input: NodeRef | None = None, **props) -> NodeRef:
...
def warp_scalar(input: NodeRef | None = None, **props) -> NodeRef:
...
def warp_vector(input: NodeRef | None = None, **props) -> NodeRef:
